...
package com.guider.baselib.widget.aAInfographicsLib.aAChartCreator

import com.guider.baselib.widget.aAInfographicsLib.aAOptionsModel.AAScrollablePlotArea
...
class AAChartModel {
    ...
    var axesTextSize: Float? = null          //x 轴和 y 轴文字大小
    ...
    var zoomType: AAChartZoomType? = null               //缩放类型 AAartZoomTypeX表示可沿着 x 轴进行手势缩放
    ...
    fun axesTextSize(prop: Float):AAChartModel{
        axesTextSize = prop
        return this
    }
