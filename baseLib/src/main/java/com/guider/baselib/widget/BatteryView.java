...
public class BatteryView extends View {
    ...
    private void drawHorizontalBattery(Canvas canvas) {
        ...
        RectF r1 = new RectF(strokeWidth_2, strokeWidth_2,
                width - strokeWidth - strokeWidth_2, height - strokeWidth_2);
        //设置外边框颜色为灰色
        paint.setColor(CommonUtils.INSTANCE.getColor(mContext,R.color.color999999));
        ...
        if (mPower >= 50) {
            paint.setColor(CommonUtils.INSTANCE.getColor(mContext,R.color.color59d15f));
        }
