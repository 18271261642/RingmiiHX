...
public class CustomBaseGlideUrlLoader extends BaseGlideUrlLoader<String> {
    ...
    public CustomBaseGlideUrlLoader(ModelLoader<GlideUrl, InputStream> concreteLoader,
    ...
    public static class Factory implements ModelLoaderFactory<String, InputStream> {
        ...
        public ModelLoader<String, InputStream> build(MultiModelLoaderFactory multiFactory) {
            return new CustomBaseGlideUrlLoader(multiFactory.build(GlideUrl.class,
                    InputStream.class), urlCache);
        }
