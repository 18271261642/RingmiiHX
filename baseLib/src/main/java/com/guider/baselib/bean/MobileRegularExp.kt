...
/**
 * @Package: com.guider.baselib.bean
 * @ClassName: MobileRegularExp
 * @Description: 国际手机号正则表达式
 * @Author: hjr
 * @CreateDate: 2020/9/3 10:31
 * Copyright (C), 1998-2020, GuiderTechnology
 */
enum class MobileRegularExp(
        /**
         * 国际名称
         */
        var national: String,
    ...
    CN("中国", "^(?:\\+?86)?1(?:3\\d{3}|5[^4\\D]\\d{2}|8\\d{3}|7(?:[235-8]\\d{2}|4(?:0\\d|1[0-2]|9\\d))|9[0-35-9]\\d{2}|66\\d{2})\\d{6}$"),
    TW("台湾", "^(\\+?886\\-?|0)?9\\d{8}$"),
    ...
    DE("德国", "^(\\+?49[ \\.\\-])?([\\(]{1}[0-9]{1,6}[\\)])?([0-9 \\.\\-\\/]{3,20})((x|ext|extension)[ ]?[0-9]{1,4})?$"), DK("丹麦", "^(\\+?45)?(\\d{8})$"),
    GR("希腊", "^(\\+?30)?(69\\d{8})$"),
    AU("澳大利亚", "^(\\+?61|0)4\\d{8}$"),
    GB("英国", "^(\\+?44|0)7\\d{9}$"),
