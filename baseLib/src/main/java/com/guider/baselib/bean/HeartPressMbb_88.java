...
public class HeartPressMbb_88 extends BaseDataSave implements Parcelable {
    ...
    public HeartPressMbb_88 setStr_dbp(String str_dbp) {
    ...
    public HeartPressMbb_88 setStr_sbp(String str_sbp) {
    ...
    public HeartPressMbb_88 setStr_heart(String str_heart) {
    ...
    public HeartPressMbb_88 set_dbp(int _dbp) {
        this._dbp = _dbp;
        return this;
    }
    ...
    public HeartPressMbb_88 set_sbp(int _sbp) {
        this._sbp = _sbp;
        return this;
    }
    ...
    public HeartPressMbb_88 set_heart(int _heart) {
        this._heart = _heart;
        return this;
    }
    ...
    public static Creator<HeartPressMbb_88> getCREATOR() {
        return CREATOR;
    }
    ...
    public static void setHeartPress(HeartPressMbb_88 heartPress) {
        HeartPressMbb_88.heartPress = heartPress;
    }
    ...
    protected HeartPressMbb_88(Parcel in) {
    ...
    public static final Creator<HeartPressMbb_88> CREATOR = new Creator<HeartPressMbb_88>() {
        @Override
        public HeartPressMbb_88 createFromParcel(Parcel source) {
            return new HeartPressMbb_88(source);
        }

        @Override
        public HeartPressMbb_88[] newArray(int size) {
            return new HeartPressMbb_88[size];
        }
    };
}
