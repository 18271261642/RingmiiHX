...
//        }
    ...
    public void startStandardRun(StandardCallback callback) {
        ...
        standardRequestBeans.add(new StandardRequestBean(accountId,Constant.XINLV,
                new Object[]{Double.valueOf(HeartRate)}));
        standardRequestBeans.add(new StandardRequestBean(accountId,Constant.YALIZHISHU,
                new Object[]{Double.valueOf(SDNN)}));
        standardRequestBeans.add(new StandardRequestBean(accountId,Constant.PILAOZHISHU,
                new Object[]{Double.valueOf(LFHF)}));
        standardRequestBeans.add(new StandardRequestBean(accountId,Constant.XINLVJIANKANG,
                new Object[]{Double.valueOf(PNN50),PredictedSymptoms}));
