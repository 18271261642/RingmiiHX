...
*/
    ...
    private static final class RestServiceHolder {
        ...
        private static RestService REST_SERVICE = null;
    }
    ...
    public static RestService getRestService() {
        if (RestServiceHolder.REST_SERVICE != null)
            return RestServiceHolder.REST_SERVICE;
        synchronized (RestServiceHolder.LOCK) {
            if (RestServiceHolder.REST_SERVICE == null) {
                String BASE_URL = ProjectInit.getConfiguration(ConfigKeys.API_HOST);
                Retrofit RETROFIT_CLIENT = new Retrofit.Builder()
                        .baseUrl(BASE_URL)
                        .client(ApiUtil.getOkHttpClient())
                        .build();
                RestServiceHolder.REST_SERVICE = RETROFIT_CLIENT.create(RestService.class);
            }
        }
        return RestServiceHolder.REST_SERVICE;
    }
