...
//        alarmAdapter.setChangeCallBack(new B30AlarmAdapter.AlarmCheckChange() {
//            @Override
...
//        MyApp.getVpOperateManager().modifyAlarm2(iBleWriteResponse, alarmDataListener, alarm2Setting);
//    }
//
//    /**
//     * 删除闹钟
...
//                        MyApp.getVpOperateManager().deleteAlarm2(iBleWriteResponse, alarmDataListener, alarm2Setting);
//                    }
//                })
...
//        MyApp.getVpOperateManager().readAlarm2(iBleWriteResponse, alarmDataListener);
//    }
//
//    /**
//     * 显示所有的闹钟数据
