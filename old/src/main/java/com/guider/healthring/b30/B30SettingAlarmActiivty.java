...
import com.guider.healthring.b30.adapter.ImageAdapter;
...
//     */
//    private void saveAlarm() {
//        if (TextUtils.isEmpty(mAlarm2Setting.getRepeatStatus())
//                || mAlarm2Setting.getRepeatStatus().equals("0000000")) {
//
//            mAlarm2Setting.setRepeatStatus(getWeek(getTimeNow()));
//            initRepeat(mAlarm2Setting.getRepeatStatus());
//        }
//        Log.d("---zza--", mAlarm2Setting.toString());
//
//        MyApp.getVpOperateManager().readAlarm2(new IBleWriteResponse() {
//            @Override
//            public void onResponse(int i) {
//
//            }
...
//
//                        if (editAlarm) {
//                            MyApp.getVpOperateManager().modifyAlarm2(iBleWriteResponse, new IAlarm2DataListListener() {
//                                @Override
//                                public void onAlarmDataChangeListListener(AlarmData2 alarmData2) {
//                                    Log.d("-----zza-修改闹钟-", alarmData2.toString());
//                                    closeLoadingDialog();
...
//                            }, mAlarm2Setting);
//                        } else {
//                            MyApp.getVpOperateManager().addAlarm2(iBleWriteResponse, new IAlarm2DataListListener() {
//                                @Override
//                                public void onAlarmDataChangeListListener(AlarmData2 alarmData2) {
//                                    closeLoadingDialog();
//                                    Log.d("-----zza-新建闹钟-", alarmData2.toString());
