...
import com.guider.healthring.bzlmaps.mapdb.GoogleMapBean;
...
//                        Log.e("GPS", "onConnectionFailed");
    ...
    private String stringpersonContent;
...
//        intent.setAction("com.guider.ringmiihx.bzlmaps.sos.SENDSMS");
...
//        getUrl = EN_ADDRESS_1 + "39.075981" + "," + "-100.680995" + EN_ADDRESS_2;
    ...
    private void sendLocationAdressRequest2(String url) {
        if (requestPressent != null) {
            requestPressent.getRequestJSONObjectGet(0x01, url, mContext, 0);
        }
    }
