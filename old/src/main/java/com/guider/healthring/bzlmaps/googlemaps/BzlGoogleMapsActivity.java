package com.guider.healthring.bzlmaps.googlemaps;
...
import com.guider.healthring.bzlmaps.PermissionUtils;
...
//                sportMaps.setDistance("0.00");
//            }
//            sportMaps.setUserId(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, "userId")) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, "userId"));
//            sportMaps.setCalories(Double.valueOf(decimalFormat.format(gpsDistance * 65.4)) + "");
//            sportMaps.setMac(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, Commont.BLEMAC)) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, Commont.BLEMAC));
//
//
...
//                }
//            }
//            latLonBean.setUserId(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, "userId")) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, "userId"));
//            latLonBean.setRtc(df.format(new Date()));
//            latLonBean.setSaveTime(df1.format(new Date()));
//            latLonBean.setMac(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, Commont.BLEMAC)) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGoogleMapsActivity.this, Commont.BLEMAC));
...
//        if (mGoogleApiClient != null) {
//            if (!mGoogleApiClient.isConnected()) mGoogleApiClient.connect();// 连接Google Play服务
//        }
//        super.onStart();
//    }
//
...
//        times++;
//        sportTimes.setText(GPSutils.FormatMiss(times));
//        try {//得到时间
//            gpsJSon.put("timeLen", GPSutils.FormatMiss(times));
//            sportMaps.setTimeLen(GPSutils.FormatMiss(times));
//        } catch (Exception E) {
//            E.printStackTrace();
//        }
//    }
...
//                if (sportTimes != null) sportTimes.setText(GPSutils.FormatMiss(times));
//                try {//得到时间
//                    gpsJSon.put("timeLen", GPSutils.FormatMiss(times));
//                    sportMaps.setTimeLen(GPSutils.FormatMiss(times));
//                } catch (Exception E) {
