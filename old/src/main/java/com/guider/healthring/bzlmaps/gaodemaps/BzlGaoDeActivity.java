...
//        if (mLocationClient.isStarted()) {
//            times++;
//            if (sportTime != null) sportTime.setText(GPSutils.FormatMiss(times));
//        }
//        try {//得到时间
...
//            }
//
//            sportMaps.setUserId(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, "userId")) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, "userId"));
//            sportMaps.setCalories(Double.valueOf(decimalFormat.format(gpsDistance * 65.4)) + "");
//            sportMaps.setMac(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, Commont.BLEMAC)) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, Commont.BLEMAC));
//
//
...
//            }
//
//            latLonBean.setUserId(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, "userId")) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, "userId"));
//            latLonBean.setRtc(df.format(new Date()));
//            latLonBean.setSaveTime(df1.format(new Date()));
//            latLonBean.setMac(TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, Commont.BLEMAC)) ? "null" : (String) SharedPreferencesUtils.readObject(BzlGaoDeActivity.this, Commont.BLEMAC));
