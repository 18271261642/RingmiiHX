...
//                w30sMonthTotalKmTv.setText("0.0" + obtainKmMile());
...
//                startActivity(new Intent(getActivity(), SportsHistoryActivity.class));
    ...
    private void getRunLiatDataDB(int runTags, String dataTime) {
        ...
        final List<SportMaps> sportMapsList = MyApp.getDBManager().getDaoSession().getSportMapsDao()
        ...
        List<LatLonBean> latLonBeanList = MyApp.getDBManager().getDaoSession().getLatLonBeanDao()
