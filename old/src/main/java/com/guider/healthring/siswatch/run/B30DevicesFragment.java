...
//        B30DevicesSportDao b30DevicesSportDao = MyApp.getDBManager().getDaoSession().getB30DevicesSportDao();
        ...
        final List<B30DevicesSport> b30DevicesSports = MyApp.getDBManager().getDaoSession().getB30DevicesSportDao().queryBuilder().where(B30DevicesSportDao.Properties.Address.eq(bm)).list();
