...
public class MoreShockActivity extends WatchBaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            if (Commont.isDebug)Log.d("------------", requestCode + "===" + resultCode);
            if (requestCode == 1) {
                switch (resultCode) {
                    case 1:
                        ...
                        if (Commont.isDebug)Log.d("====1====", mShockTimeS + "===" + mStartShockTimeS + "--" + mStopShockTimeS);
                    ...
                    case 2:
                        ...
                        if (Commont.isDebug)Log.d("====2====", mShockTimeD + "===" + mStartShockTimeD + "--" + mStopShockTimeD);
                    ...
                    case 3:
                        ...
                        if (Commont.isDebug)Log.d("====3====", mShockTimeM + "===" + mStartShockTimeM + "--" + mStopShockTimeM);
                    ...
                    case 4:
                        ...
                        if (Commont.isDebug)Log.d("====4====", mDataShockTime + "===" + mTimeShockTime);
                        ...
                        if (Commont.isDebug)Log.d("=====会议设置时间=返回==", yearM + "-" + motohM + "-" + dayM + " " + hourM + ":" + minM);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            ...
            case R.id.sw_metting_remind:
                ...
                if (Commont.isDebug)Log.d("-会议设置-year--", year[0].substring(2, 4) + "=- 年--=" + year[0] + "==月==" + year[1] + "==日==" + year[2]);
                if (Commont.isDebug)Log.d("-会议设置-time--", time[0] + "=" + time[1]);
                int yearM = (int) Integer.valueOf(year[0].substring(2, 4));
                int motohM = (int) Integer.valueOf(year[1]);
                int dayM = (int) Integer.valueOf(year[2]);
                int hourM = (int) Integer.valueOf(time[0]);
                int minM = (int) Integer.valueOf(time[1]);
                if (Commont.isDebug)Log.d("=====会议设置时间===", yearM + "-" + motohM + "-" + dayM + " " + hourM + ":" + minM + "==stuta==" + isChecked);
