...
//    private static final String FileStringPath = Environment.getExternalStorageDirectory()+"/RaceFit/";//"/storage/emulated/0/Android/com.bozlun.bozhilun.android/cache/W30V3.zip";
    ...
    private void init() {
        ...
        String mylanmac = (String) SharedPreferenceUtil.get(NewW30sFirmwareUpgrade.this, Commont.BLEMAC, "");
...
//                                starter.setZip(R.raw.w30s_v_30_5);
    ...
    public void dis() {
        ...
        com.guider.healthring.siswatch.utils.SharedPreferenceUtil.put(MyApp.getContext(), "mylanya", "");
