...
public class B18IBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        final String mylanmac = (String) SharedPreferenceUtil.get(context, Commont.BLEMAC, "");
...
//        }
    ...
    BluetoothAdapter.LeScanCallback leScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
            String mylanmac = (String) SharedPreferenceUtil.get(MyApp.getContext(), Commont.BLEMAC, "");
