...
import com.guider.healthring.h9.bean.HeartDataBean;
import com.guider.healthring.h9.utils.H9HearteDataAdapter;
...
//        leafLineChart.postInvalidate();
        ...
        if (is18i.equals("W30S")) {
            if (MyCommandManager.DEVICENAME != null && MyCommandManager.DEVICENAME == "W30") {
                map.put("deviceCode", (String) SharedPreferenceUtil.get(H9HearteDataActivity.this, Commont.BLEMAC, ""));
            }
        } else {
