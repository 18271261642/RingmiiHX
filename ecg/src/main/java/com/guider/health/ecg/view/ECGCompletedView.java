...
public class ECGCompletedView extends View {
    ...
    public ECGCompletedView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 获取自定义的属性
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress > 0) {
            ...
            canvas.drawArc(oval, -90, ((float) (mTotalProgress-mProgress) / mTotalProgress) * 360, false, mRingPaint); // //字体
