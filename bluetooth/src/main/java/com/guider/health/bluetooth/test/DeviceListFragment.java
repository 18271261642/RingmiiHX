...
//
//            @Override
//            public void cancelPari(BluetoothDevice btDevice) {
//                listAdapter.notifyDataSetChanged();
//            }
//        });
//
...
//                //以后处理
//                Log.i(TAG, "accept:点击位置 ：" + position);
...
//        // 开启客户端线程，连接点击的远程设备
//
//        clientThread = new ClientThread(device1, uiHandler);
...
//        super.onResume();
//
//        System.out.println("onResume运行了");
//        Boolean b = Bluetooth.getInstance().openBlueTooth(getActivity());
//        if (b){
//            Bluetooth.getInstance().getBondDevices(deviceList);
//            listAdapter.notifyDataSetChanged();
//        }
//
////        // 蓝牙未打开，询问打开
...
//                Bluetooth.getInstance().setBluetoothEnableVisibility(getActivity());
//                break;
//            case R.id.discovery:
...
//
//                Bluetooth.getInstance().searchBluetoothDevices(getActivity());
//                break;
...
//            devicePair = itemView.findViewById(R.id.device_pair);
//        }
//
//    }
//
