package com.guider.map.activity.wyl_util.service;
...
import com.guider.healthring.h9.h9monitor.CommandResultCallback;
...
//                    Log.e(TAG, "-------newmsg--2--" + h9Msg);
                    ...
                    if (packageName.equals(LINE_PACKAGENAME)) {
                        ...
                        if (other) {
                            sendB30Msg(ESocailMsg.LINE, "Line", h9Msg);
                        } else {
                            if (isLine) sendB30Msg(ESocailMsg.LINE, "Line", h9Msg);
                        }
                        ...
                        try {
                            if (MyCommandManager.DEVICENAME != null) {
                                if (MyCommandManager.DEVICENAME.equals("W30")) {
                                    if (!WatchUtils.isEmpty(w30SBleName) && w30SBleName.equals("W30")) {
                                        sendMsgW30S(h9Msg, W30SBLEManage.NotifaceMsgLine);
                                    }
                                } else {
                                    //B18I手环
                                    setSocialSMS(h9Msg, "Line");
                        ...
                        if (packageName.equals(QQ_PACKAGENAME)) {
                            ...
                            if (other) {
                                ...
                                if (isQQ) sendB30Msg(ESocailMsg.QQ, "QQ", h9Msg);
                            }
                            ...
                            if (other) {
                                ...
                                if (isWechart) sendB30Msg(ESocailMsg.WECHAT, "Wechat", h9Msg);
                            }
                        ...
                        //facebook
                            ...
                            if (other) {
                                ...
                                if (isFacebook) sendB30Msg(ESocailMsg.FACEBOOK, "FaceBook", h9Msg);
                            }
                        ...
                        //Twitter
                            ...
                            if (other) {
                                ...
                                if (isTwitter) sendB30Msg(ESocailMsg.TWITTER, "Twitter", h9Msg);
                            }
                        ...
                        //Whats
                            ...
                            if (other) {
                                ...
                                if (isWhats) sendB30Msg(ESocailMsg.WHATS, "Whats", h9Msg);
                            }
                        ...
                        //viber
                            ...
                            if (other) {
                                sendB30Mesage(ESocailMsg.SMS, "MMS", h9Msg);
                            } else {
                                if (isMSG) sendB30Mesage(ESocailMsg.SMS, "MMS", h9Msg);
                            }
//                            sendB30Mesage(ESocailMsg.SMS, "MMS", h9Msg);
                            if (MyCommandManager.DEVICENAME != null) {
                                try {
                            ...
                            if (other) {
                                ...
                                if (isSkype) sendB30Msg(ESocailMsg.SKYPE, "Skype", h9Msg);
                            }
                        ...
                        } else if (packageName.equals(GMAIL_PACKAGENAME)) {
                            boolean isGmail = (boolean) SharedPreferencesUtils.getParam(MyApp.getContext(), Commont.ISGmail, false);
                            if (other) {
                                sendB30Msg(ESocailMsg.GMAIL, "Gmail", h9Msg);
                            } else {
                                if (isGmail) sendB30Msg(ESocailMsg.GMAIL, "Gmail", h9Msg);
                            }

                        } else if (packageName.equals(INSTAGRAM_PACKAGENAME)) {
                            boolean isInstagram = (boolean) SharedPreferencesUtils.getParam(MyApp.getContext(), Commont.ISInstagram, false);
                            if (other) {
                                sendB30Msg(ESocailMsg.INSTAGRAM, "Instagram", h9Msg);
                            } else {
