...
public class RouteProcessor extends AbstractProcessor {
    ...
    private void processRoute(Set<? extends Element> routeElements) {
        ...
        for (Element element : routeElements) {
            ...
            // 检查是否配置 group 如果没有配置 则从path截取出组名   组都保存在groupMap中
    ...
    private void generatedRoot(TypeElement iRouteRoot, TypeElement iRouteGroup) throws IOException {
        ...
        //函数体
        //routes.put("module2", DNRouter$$Group$$module2.class);
...
//              类似于 String.format() 的写法
            ...
            try {
                //这句就把java文件写到 generated/source/apt/debug/下
    ...
    /**
     * 检查是否配置group 如果没有配置 则从path截取出组名: "/main/test"  main就是group
     * 不同组保存在不同List中
     * @param routeMeta
     */
    ...
    private boolean routeVerify(RouteMeta routeMeta) {
        ...
        //如果group没有设置 那么defaultGroup就当作一个Group
