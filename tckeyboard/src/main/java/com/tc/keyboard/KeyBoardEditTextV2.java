...
public class KeyBoardEditTextV2 extends AppCompatEditText {
    ...
    public KeyBoardEditTextV2(Context context) {
        this(context, null);
    }

    public KeyBoardEditTextV2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KeyBoardEditTextV2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initPopWindow(View contentView) {
        // mKeyboardWindow = new PopupWindow(contentView, MyViewUtils.getScreenWidth(activity), ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    protected void showKeyboardWindow() {
        if (null != mKeyboardWindow) {
            if (!mKeyboardWindow.isShowing()) {
                mKeyboardWindow.showAtLocation(this.mDecorView, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL, 0, 0);
