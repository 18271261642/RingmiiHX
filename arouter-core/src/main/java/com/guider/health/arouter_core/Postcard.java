...
public class Postcard extends RouteMeta {
    ...
    public Postcard(String path, String group) {
        this(0, null, path, group, null);
    }

    public Postcard(int idR, String path, String group) {
        this(idR, null, path, group, null);
    }

    public Postcard(int idR, String tag, String path, String group) {
        this(idR, tag, path, group, null);
    }

    public Postcard(int idR, String tag, String path, String group, Bundle bundle) {
        setIdR(idR);
        setPath(path);
        setGroup(group);
        setTag(tag);
