...
public abstract class MedCheckFragment extends BaseFragment {
    ...
    private void onPermissionDenied() {
        PermissionHelper.showDialog(getContext(), getString(com.getmedcheck.lib.R.string.permission_label),
                getString(com.getmedcheck.lib.R.string.permission_setting_message),
                getString(com.getmedcheck.lib.R.string.dialog_label_setting), new OnDialogClickListener() {
                    @Override
    ...
    private void showPermissionRationale() {
        PermissionHelper.showDialog(getContext(), getString(com.getmedcheck.lib.R.string.permission_label),
                getString(com.getmedcheck.lib.R.string.permission_message),
                getString(com.getmedcheck.lib.R.string.dialog_label_allow), new OnDialogClickListener() {
                    @Override
                    public void onDialogClick(DialogInterface dialog, int buttonType) {
