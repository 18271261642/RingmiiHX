 ...
 * 移动版血压仪
 */
public class ViewHolderOfBp extends BaseResultViewHolder {

    TextView tvName;

    public ViewHolderOfBp(ViewGroup viewGroup) {
        super(viewGroup);
    ...
    void setResult(Object result) {
        if (hasData()) {
            Unit unit = new Unit();
            HeartPressBp instance = HeartPressBp.getInstance();
    ...
    public void request(final RequestCallback callback) {
        ...
        try {
            ...
            jsonObject.put("deviceCode", HeartPressBp.getInstance().getDeviceAddress());
            jsonObject.put("heartBeat", Integer.parseInt(HeartPressBp.getInstance().getHeart()));
            jsonObject.put("dbp", Integer.parseInt(HeartPressBp.getInstance().getDbp()));
            jsonObject.put("sbp", Integer.parseInt(HeartPressBp.getInstance().getSbp()));
