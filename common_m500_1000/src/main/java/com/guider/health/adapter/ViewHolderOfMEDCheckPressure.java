...
/**
 * MEDCheck血压 TODO 添加新设备面板
 */
public class ViewHolderOfMEDCheckPressure extends BaseResultViewHolder {

    TextView tvName;

    public ViewHolderOfMEDCheckPressure(ViewGroup viewGroup) {
        super(viewGroup);
    ...
    protected int getLayout() {
        return R.layout.item_cx;
    }

    @Override
    protected String getName() {
        return getContext().getResources().getString(R.string.blood_pressure);
    }
    ...
    void setResult(Object result) {
        if (hasData()) {
            Unit unit = new Unit();
            MEDCHECKPressure instance = MEDCHECKPressure.getMEDCHECKPressureInstance();
    ...
    public void request(final RequestCallback callback) {
        ...
        try {
            ...
            Log.i("medcheckpre", "获取到时间: " + dateString);
            ...
            jsonObject.put("dbp",
                    Integer.parseInt(MEDCHECKPressure.getMEDCHECKPressureInstance().getDbp()));
            jsonObject.put("sbp",
                    Integer.parseInt(MEDCHECKPressure.getMEDCHECKPressureInstance().getSbp()));
            ...
            Httper.getInstance().post(NetIp.BASE_URL_apihd,
                    "api/v1/bloodpressure", requestBody, new Callback<ResponseBody>() {
                @Override
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
                        ...
                        Log.i("medcheckpre", "|_____bp请求: " + result);
    ...
    public boolean hasData() {
        return MEDCHECKPressure.getMEDCHECKPressureInstance().isTag();
    }
}
