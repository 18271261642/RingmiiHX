 ...
 * 移动版血压仪
 */
public class ViewHolderOfCx extends BaseResultViewHolder {

    TextView tvName;

    public ViewHolderOfCx(ViewGroup viewGroup) {
        super(viewGroup);
    ...
    void setResult(Object result) {
        if (hasData()) {
            Unit unit = new Unit();
            HeartPressCx instance = HeartPressCx.getInstance();
    ...
    public void request(final RequestCallback callback) {
        ...
        try {
            ...
            jsonObject.put("deviceCode", HeartPressCx.getInstance().getDeviceAddress());
            jsonObject.put("heartBeat", Integer.parseInt(HeartPressCx.getInstance().getHeart()));
            jsonObject.put("dbp", Integer.parseInt(HeartPressCx.getInstance().getDbp()));
            jsonObject.put("sbp", Integer.parseInt(HeartPressCx.getInstance().getSbp()));
    ...
    public boolean hasData() {
        return HeartPressCx.getInstance().isTag();
    }
}
