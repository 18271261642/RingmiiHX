 ...
 * 移动版血压仪
 */
public class ViewHolderOfMbb88 extends BaseResultViewHolder {

    TextView tvName;

    public ViewHolderOfMbb88(ViewGroup viewGroup) {
        super(viewGroup);
    ...
    void setResult(Object result) {
        if (hasData()) {
            Unit unit = new Unit();
            HeartPressMbb_88 instance = HeartPressMbb_88.getInstance();
    ...
    public void request(final RequestCallback callback) {
        ...
        try {
            ...
            jsonObject.put("deviceCode", HeartPressMbb_88.getInstance().getDeviceAddress());
            jsonObject.put("heartBeat", Integer.parseInt(HeartPressMbb_88.getInstance().getHeart()));
            jsonObject.put("dbp", Integer.parseInt(HeartPressMbb_88.getInstance().getDbp()));
            jsonObject.put("sbp", Integer.parseInt(HeartPressMbb_88.getInstance().getSbp()));
    ...
    public boolean hasData() {
        return HeartPressMbb_88.getInstance().isTag();
    }
}
