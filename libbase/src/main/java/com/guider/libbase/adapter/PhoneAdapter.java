package com.guider.libbase.adapter;
...
public class PhoneAdapter extends BaseAdapter {
    List<AreaCode>phoneHeadList;
    Context context;
    LayoutInflater layoutInflater;

    public PhoneAdapter(List<AreaCode> phoneHeadList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AreaCode areCodeBean = phoneHeadList.get(position);
        //国家英文名称
