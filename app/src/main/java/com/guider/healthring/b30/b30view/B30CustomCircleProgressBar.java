...
public class B30CustomCircleProgressBar extends View {
    ...
    public B30CustomCircleProgressBar(Context context) {
        this(context, null);
    }

    public B30CustomCircleProgressBar(Context context, AttributeSet attrs) {
    ...
    public B30CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void startAnim(float startProgress,int dur) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                B30CustomCircleProgressBar.this.progress = (float) animation.getAnimatedValue();
                postInvalidate();
            }
        });
