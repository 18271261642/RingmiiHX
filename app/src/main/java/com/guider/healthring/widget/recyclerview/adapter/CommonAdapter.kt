package com.guider.healthring.widget.recyclerview.adapter

import android.content.Context
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.guider.healthring.widget.recyclerview.MultipleType
...
abstract class CommonAdapter<T>(
    ...
    fun setSourceList(list: List<T>?) {
        if (list != null) {
            mData = list as ArrayList<T>
