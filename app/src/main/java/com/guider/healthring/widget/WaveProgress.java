...
import com.guider.healthring.util.MiscUtil;
...
public class WaveProgress extends View {
    ...
    private void initPaint(Context mContext) {
        ...
        // 设置绘制文字大小
        mHintPaint.setTextSize(MiscUtil.dipToPx(mContext,20));
        // 设置画笔颜色
        ...
        setTagPaint.setTextSize(MiscUtil.dipToPx(mContext,15));
...
//                            + ";value = " + mValue);
        ...
        if (mProgressAnimator != null) mProgressAnimator.start();
    }
