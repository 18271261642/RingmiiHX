...
import com.guider.healthring.b30.b30view.CusWrapListView;
...
import com.guider.healthring.b31.hrv.GlossaryDetailActivity;
...
import static com.guider.healthring.b31.bpoxy.enums.EnumGlossary.LOWOXGEN;
import static com.guider.healthring.b31.bpoxy.enums.EnumGlossary.LOWREAMIN;
import static com.guider.healthring.b31.bpoxy.enums.EnumGlossary.OSHAHS;
import static com.guider.healthring.b31.bpoxy.enums.EnumGlossary.OXGEN;
import static com.guider.healthring.b31.bpoxy.enums.EnumGlossary.SLEEP;
import static com.guider.healthring.b31.bpoxy.enums.EnumGlossary.SLEEPBREATHBREAKTIP;
...
public class B31BpOxyAnysisActivity extends WatchBaseActivity {
    ...
    private void showSpo2Desc(List<Spo2hOriginData> list) {
        ...
        //OSAHS程度
        osahsStatusTv.setText(getOsahs(spo2hOriginUtil.getIsHypoxia()));
...
//        }
        ...
        if (osahs >= 3) {
            ...
            return getResources().getString(R.string.vpspo2h_state_little);
        } else {
            return getResources().getString(R.string.vpspo2h_state_normal);
        }
    }
