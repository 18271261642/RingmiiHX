...
public class FORAOxygenSaturationUtil extends FORA {
	public OxygenSaturationTool tool;
	...
	public interface OxygenSaturationTool {
	...
	public void setOnFORADateFormatTool(OxygenSaturationTool tool){
		this.tool = tool;
	}
...
//		httpParams.append("Day=").append(params[3]).append(separator);
		...
		httpParams.append("DataType=").append("7").append(separator);
