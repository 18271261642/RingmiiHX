...
public class FORABloodGlucoseUtil extends FORA {
	public BloodGlucoseTool tool;
	...
	public interface BloodGlucoseTool {
	...
	public void setOnFORADateFormatTool(BloodGlucoseTool tool){
		this.tool = tool;
	}
...
//		}
	...
	public String getHttpParams(String... params) {
		...
		httpParams.append("DeviceType=").append("4272").append(separator);
...
//		httpParams.append("Day=").append(params[3]).append(separator);
		...
		httpParams.append("DataType=").append("1").append(separator);
