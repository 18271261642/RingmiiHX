...
import com.inuker.bluetooth.library1.old.connect.BleConnectManager;
...
import com.inuker.bluetooth.library1.old.search.BluetoothSearchManager;
...
public class BluetoothServiceImpl extends IBluetoothService.Stub implements Handler.Callback {
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case Constants.CODE_REQUEST_MTU:
                int mtu = args.getInt(Constants.EXTRA_MTU);
