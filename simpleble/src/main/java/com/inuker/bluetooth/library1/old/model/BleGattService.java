package com.inuker.bluetooth.library1.old.model;
...
public class BleGattService implements Parcelable, Comparable {
    ...
    private List<BleGattCharacterOld> characters;
    ...
    public BleGattService(UUID uuid, Map<UUID, BluetoothGattCharacteristic> characters) {
        ...
        while (itor.hasNext()) {
            ...
            getCharacters().add(new BleGattCharacterOld(characteristic));
        }
    }
    ...
    protected BleGattService(Parcel in) {
        ...
        characters = in.createTypedArrayList(BleGattCharacterOld.CREATOR);
    }
    ...
    public List<BleGattCharacterOld> getCharacters() {
        if (characters == null) {
            characters = new ArrayList<BleGattCharacterOld>();
        }
        return characters;
    }
    ...
    public String toString() {
        ...
        List<BleGattCharacterOld> characters = getCharacters();
