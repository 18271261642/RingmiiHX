...
import com.inuker.bluetooth.library1.old.search.classic.BluetoothClassicSearcher;
import com.inuker.bluetooth.library1.old.search.le.BluetoothLESearcher;
import com.inuker.bluetooth.library1.old.search.response.BluetoothSearchResponse;

import static com.inuker.bluetooth.library1.old.Constants.SEARCH_TYPE_BLE;
import static com.inuker.bluetooth.library1.old.Constants.SEARCH_TYPE_CLASSIC;
