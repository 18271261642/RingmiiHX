...
import com.inuker.bluetooth.library.old.search.classic.BluetoothClassicSearcher;
import com.inuker.bluetooth.library.old.search.le.BluetoothLESearcher;
import com.inuker.bluetooth.library.old.search.response.BluetoothSearchResponse;

import static com.inuker.bluetooth.library.old.Constants.SEARCH_TYPE_BLE;
import static com.inuker.bluetooth.library.old.Constants.SEARCH_TYPE_CLASSIC;
