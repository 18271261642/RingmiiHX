...
import com.inuker.bluetooth.library.old.connect.response.BleMtuResponse;
import com.inuker.bluetooth.library.old.connect.response.BleNotifyResponse;
import com.inuker.bluetooth.library.old.connect.response.BleReadResponse;
import com.inuker.bluetooth.library.old.connect.response.BleReadRssiResponse;
import com.inuker.bluetooth.library.old.connect.response.BleUnnotifyResponse;
import com.inuker.bluetooth.library.old.connect.response.BleWriteResponse;
import com.inuker.bluetooth.library.old.connect.response.BluetoothResponse;
import com.inuker.bluetooth.library.old.model.BleGattProfile;
import com.inuker.bluetooth.library.old.receiver.BluetoothReceiver;
import com.inuker.bluetooth.library.old.receiver.listener.BleCharacterChangeListener;
import com.inuker.bluetooth.library.old.receiver.listener.BleConnectStatusChangeListener;
import com.inuker.bluetooth.library.old.receiver.listener.BluetoothBondListener;
import com.inuker.bluetooth.library.old.receiver.listener.BluetoothBondStateChangeListener;
import com.inuker.bluetooth.library.old.receiver.listener.BluetoothStateChangeListener;
...
import com.inuker.bluetooth.library.old.utils.BluetoothLog;
import com.inuker.bluetooth.library.old.utils.ListUtils;
import com.inuker.bluetooth.library.old.utils.proxy.ProxyBulk;
import com.inuker.bluetooth.library.old.utils.proxy.ProxyInterceptor;
import com.inuker.bluetooth.library.old.utils.proxy.ProxyUtils;
...
import static com.inuker.bluetooth.library.old.Constants.CODE_CLEAR_REQUEST;
import static com.inuker.bluetooth.library.old.Constants.CODE_CONNECT;
import static com.inuker.bluetooth.library.old.Constants.CODE_DISCONNECT;
import static com.inuker.bluetooth.library.old.Constants.CODE_INDICATE;
import static com.inuker.bluetooth.library.old.Constants.CODE_NOTIFY;
import static com.inuker.bluetooth.library.old.Constants.CODE_READ;
import static com.inuker.bluetooth.library.old.Constants.CODE_READ_DESCRIPTOR;
import static com.inuker.bluetooth.library.old.Constants.CODE_READ_RSSI;
import static com.inuker.bluetooth.library.old.Constants.CODE_REFRESH_CACHE;
import static com.inuker.bluetooth.library.old.Constants.CODE_SEARCH;
import static com.inuker.bluetooth.library.old.Constants.CODE_STOP_SESARCH;
import static com.inuker.bluetooth.library.old.Constants.CODE_UNNOTIFY;
import static com.inuker.bluetooth.library.old.Constants.CODE_WRITE;
import static com.inuker.bluetooth.library.old.Constants.CODE_WRITE_DESCRIPTOR;
import static com.inuker.bluetooth.library.old.Constants.CODE_WRITE_NORSP;
import static com.inuker.bluetooth.library.old.Constants.DEVICE_FOUND;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_BYTE_VALUE;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_CHARACTER_UUID;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_DESCRIPTOR_UUID;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_GATT_PROFILE;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_MAC;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_MTU;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_OPTIONS;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_REQUEST;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_RSSI;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_SEARCH_RESULT;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_SERVICE_UUID;
import static com.inuker.bluetooth.library.old.Constants.EXTRA_TYPE;
import static com.inuker.bluetooth.library.old.Constants.REQUEST_SUCCESS;
import static com.inuker.bluetooth.library.old.Constants.SEARCH_CANCEL;
import static com.inuker.bluetooth.library.old.Constants.SEARCH_START;
import static com.inuker.bluetooth.library.old.Constants.SEARCH_STOP;
import static com.inuker.bluetooth.library.old.Constants.SERVICE_UNREADY;
import static com.inuker.bluetooth.library.old.Constants.CODE_REQUEST_MTU;
import static com.inuker.bluetooth.library.old.Constants.GATT_DEF_BLE_MTU_SIZE;
